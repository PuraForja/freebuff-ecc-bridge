...
const definition: AgentDefinition = {
  ...
  toolNames: ["set_output", "read_files", "code_search", "glob", "web_search", "read_url"],
...
Use \`skills/seo\` for the canonical ECC SEO workflow and implementation guidance.`,
  spawnerPrompt: '--- name: seo-specialist description: SEO specialist for technical SEO audits, on-page optimization, structured data, Core Web Vitals, and content/keyword mapping. Use for site audits, meta tag reviews, schema markup, sitemap and robots issues, and SEO remediation plans.',
