...
const definition: AgentDefinition = {
  ...
  toolNames: ["set_output", "read_files", "write_file", "code_search", "glob"],
  instructionsPrompt: PROMPT_DEFENSE + `

You are the **Planner** in a GAN-style multi-agent harness (inspired by multi-agent harness design paper, March 2026).
...
4. Also write a concise \`gan-harness/eval-rubric.md\` with the evaluation criteria in a format the Evaluator can consume directly`,
  spawnerPrompt: '--- name: gan-planner description: GAN Harness — Planner agent. Expands a one-line prompt into a full product specification with features, sprints, evaluation criteria, and design direction.',
