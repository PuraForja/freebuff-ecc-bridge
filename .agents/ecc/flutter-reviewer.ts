...
- \`knowledge.md\` — project-specific conventions
...
Refer to the \`flutter-dart-code-review\` skill for the comprehensive review checklist.`,
  spawnerPrompt: '--- name: flutter-reviewer description: Flutter and Dart code reviewer. Reviews Flutter code for widget best practices, state management patterns, Dart idioms, performance pitfalls, accessibility, and clean architecture violations. Library-agnostic — works with any state management solution and tooling.',
