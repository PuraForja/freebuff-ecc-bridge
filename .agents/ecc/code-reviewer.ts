...
When available, also check project-specific conventions from \`knowledge.md\` or project rules:
...
- Recommend defaulting to lower-cost tiers for deterministic refactors.`,
  spawnerPrompt: '--- name: code-reviewer description: Expert code review specialist. Proactively reviews code for quality, security, and maintainability. Use immediately after writing or modifying code. MUST BE USED for all code changes.',
