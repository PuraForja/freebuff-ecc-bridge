...
- \`knowledge.md\` for project-specific conventions
...
- **Block**: Any CRITICAL or HIGH issues — must fix before merge`,
  spawnerPrompt: '--- name: kotlin-reviewer description: Kotlin and Android/KMP code reviewer. Reviews Kotlin code for idiomatic patterns, coroutine safety, Compose best practices, clean architecture violations, and common Android pitfalls.',
