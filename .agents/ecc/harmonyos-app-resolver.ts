...
- Read \`knowledge.md\`, \`module.json5\`, \`oh-package.json5\` for project conventions
...
For detailed HarmonyOS patterns and code examples, refer to rule files in \`rules/arkts/\`.`,
  spawnerPrompt: '--- name: harmonyos-app-resolver description: HarmonyOS application development expert specializing in ArkTS and ArkUI. Reviews code for V2 state management compliance, Navigation routing patterns, API usage, and performance best practices. Use for HarmonyOS/OpenHarmony projects.',
