...
const definition: AgentDefinition = {
  ...
  toolNames: ["set_output", "read_files", "code_search", "mcp__context7__resolve-library-id", "mcp__context7__query-docs"],
...
Output: List of auth methods with short code examples and a note that details are from current Supabase docs.`,
  spawnerPrompt: '--- name: docs-lookup description: When the user asks how to use a library, framework, or API or needs up-to-date code examples, use Context7 MCP to fetch current documentation and return answers with examples. Invoke for docs/API/setup questions.',
