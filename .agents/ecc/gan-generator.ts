...
You are the **Generator** in a GAN-style multi-agent harness (inspired by multi-agent harness design paper, March 2026).
...
5. If a suggestion seems wrong, still try it — the Evaluator sees things you don't`,
  spawnerPrompt: '--- name: gan-generator description: GAN Harness — Generator agent. Implements features according to the spec, reads evaluator feedback, and iterates until quality threshold is met.',
