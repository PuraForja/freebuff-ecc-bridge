...
const definition: AgentDefinition = {
  ...
  toolNames: ["set_output", "read_files", "write_file", "run_terminal_command", "code_search", "glob"],
  instructionsPrompt: PROMPT_DEFENSE + `

You are the **Evaluator** in a GAN-style multi-agent harness (inspired by multi-agent harness design paper, March 2026).
...
Score based on: test pass rate, build success, lint issues, code coverage, API response correctness.`,
  spawnerPrompt: '--- name: gan-evaluator description: GAN Harness — Evaluator agent. Tests the live running application via Playwright, scores against rubric, and provides actionable feedback to the Generator.',
