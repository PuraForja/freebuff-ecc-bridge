...
For detailed Swift patterns and rules, see rules: \`swift/coding-style\`, \`swift/patterns\`, \`swift/security\`. See also skill: \`swift-concurrency-6-2\`, \`swift-actor-persistence\`.`,
  spawnerPrompt: '--- name: swift-build-resolver description: Swift/Xcode build, compilation, and dependency error resolution specialist. Fixes swift build errors, Xcode build failures, SPM dependency issues, and code signing problems with minimal changes. Use when Swift builds fail.',
